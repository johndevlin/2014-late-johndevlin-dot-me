...
<body>
		...
		<div class="container">
			...
			<nav class="desktop-nav">
				...
				<ul class="inline-list">
					...
					<li><a class="social-link icon-twitter" target="_blank" href="https://twitter.com/john_devlin">Twitter</a></li>

					<li><a class="social-link icon-github" target="_blank" href="https://github.com/johndevlin/">Github</a></li>

					<li><a class="social-link icon-dribbble" target="_blank" href="https://dribbble.com/John_Devlin">Dribbble</a></li>
		...
		<div class="container work">
			...
			<section>
				...
				<aside>
					...
					<h3>
						<a href="http://rehabstudio.com/">+ rehabstudio</a> <br />
						<a href="http://soonintokyo.com/">Soon in Tokyo</a>
					</h3>
				...
				<figure>
					<img src="http://johndevlin.me/assets/production/img/the-restart-project.jpg" alt="Restart Project" />
				</figure>
			...
			<section>
				...
				<aside>
					...
					<h3>
						<a href="http://rehabstudio.com/">Mammoth</a> <br />
						<a href="http://soonintokyo.com/">Atto Partners</a>
					</h3>
				...
				<figure>
					<img src="http://johndevlin.me/assets/production/img/carson-mcdowell.jpg" alt="Carson McDowell" />
				</figure>
	...
	<footer>
		<div class="container">
			...
			<p class="copyright">
				&copy; <span class="current-year">2014 &dash; present</span>
			</p>

			<p class="colophon">
				This site is set in <a href="http://sorkintype.com/fonts.html#mw">Merriweather</a> &amp; <a href="http://sorkintype.com/fonts.html#arm">Armata</a>, designed by <a href="http://sorkintype.com/">Sorkin Type</a>, and served by <a href="http://www.google.com/fonts/">Google Web Fonts</a>. It was build using <a href="https://github.com/johndevlin/Trigger">Trigger</a>, <a href="http://gruntjs.com/">Grunt</a> &amp; <a href="http://sass-lang.com/">Sass</a>.
			</p>
